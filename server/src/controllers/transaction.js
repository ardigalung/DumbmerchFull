...
exports.addTransaction = async (req, res) => {
  try {
    ...
    // Create Snap API instance /persiapan membuat token
    ...
    //sudah default seperti ini bentuknya
    let parameter = {
      transaction_details: {
        order_id: newData.id,
    ...
    //alur backen request ke mintransd membuat token
...
exports.notification = async (req, res) => {
  try {
    ...
    //diambil berdasarkan propterti kartu
...
const sendEmail = async (status, transactionId) => {
  ...
  // Send an email if there is a change in the transaction status mintrans dan database
